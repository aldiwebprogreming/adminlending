  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark"><i class="far fa-id-card"></i> Halaman Section 4</h1><hr>
                              ...
                              <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                  ...
                                  <div class="modal-body">
                                      ...
                                      <form method="post" action="<?= base_url('admin/hapus_section4') ?>" enctype="multipart/form-data">
                              ...
                              <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                  ...
                                  <div class="modal-body">
                                      ...
                                      <form method="post" action="<?= base_url('admin/edit_section4') ?>" enctype="multipart/form-data">
                                        <input type="hidden" name="id" class="form-control" value="<?= $data['id'] ?>">
                                        <div class="form-group">
                                          <label for="exampleInputEmail1">Title</label>
